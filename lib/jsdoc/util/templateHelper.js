...
exports.getMembers = function(data) {
    var members = {
        classes: find( data, function(data){
            return this.kind == 'class' && this.longname.indexOf("external:") !== 0;
        }),
        externals: find( data, function(data){
            return this.kind === 'external' || (this.kind == 'class' && this.longname.indexOf("external:") === 0);
        }),
